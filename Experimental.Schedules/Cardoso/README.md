...
![](figure/Cardosounnamed-chunk-3.png) 
...
![](figure/Cardosounnamed-chunk-4.png) 
...
![](figure/Cardosounnamed-chunk-5.png) 
...
![](figure/Cardosounnamed-chunk-6.png) 
...
![The control treatment bromeliad (i.e. *mu1k1*, black line) compared with the rainfall data, to demonstrate that they are very similar in temporal pattern](figure/Cardosounnamed-chunk-7.png) 


![As the above, but each year (and the control plant) is in a separate panel.](figure/Cardosounnamed-chunk-8.png) 
